            ...
            title={
              <Box padding="10px" display="flex" flexDirection="column" gap="10px">
                ...
                <Box style={{ display: 'flex', justifyContent: 'space-between' }}>
                  ...
                  <Button variant="contained" endIcon={<ArrowForwardIos />} onClick={() => setTooltipId(10)}>NEXT</Button>
                </Box>
              </Box>
            }
          ...
          title={
            <Box padding="10px" display="flex" flexDirection="column" gap="10px">
              ...
              <Box style={{ display: 'flex', justifyContent: 'space-between' }}>
                ...
                <Button variant="contained" endIcon={<ArrowForwardIos />} onClick={() => setTooltipId(11)}>OKAY</Button>
              </Box>
            </Box>
          }
          placement="left"
